...
function preload() {
    ...
    jeff = loadImage("images/jeff.png");

    carttoncat = loadImage("images/carttoncat.png");

    taillexe = loadImage("images/taillexe.png");

    sonicexe = loadImage("images/sonicexe.png");

    freedy = loadImage("images/freedy.png");

    sllenderman = loadImage("images/sllenderman.png");

    line = loadImage("images/line.jpg");

    restart = loadImage("images/restart.jpg");

    scarydoor = loadImage("images/scarydoor.jpg");
...
function draw() {
    ...
    function reset() {               gameState = PLAY;               restart.visible = false;           }
    function move(event) {               var k = event.keyCode;
        var boy = {
        ...
        boy.style.top = (boy.updown()) + "px";               boy.style.left = (boy.leftright()) + "px";
    }